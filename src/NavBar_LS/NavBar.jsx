                  ...
                  <div className="d-flex flex-column mb-2 ps-5 pe-5 ">
                    ...
                    >
                      <img
                        role="presentation"
                        alt=""
                        srcset="https://secure.meetupstatic.com/next/images/login/facebook.svg?w=32 1x, https://secure.meetupstatic.com/next/images/login/facebook.svg?w=48 2x"
                        src="https://secure.meetupstatic.com/next/images/login/facebook.svg?w=48"
                    ...
                    >
                      <img
                        role="presentation"
                        alt=""
                        srcset="https://secure.meetupstatic.com/next/images/login/google.svg?w=32 1x, https://secure.meetupstatic.com/next/images/login/google.svg?w=48 2x"
                    ...
                    >
                      <img
                        role="presentation"
                        alt=""
                        srcset="https://secure.meetupstatic.com/next/images/login/apple.svg?w=32 1x, https://secure.meetupstatic.com/next/images/login/apple.svg?w=48 2x"
                  ...
                  <div className="d-flex flex-column mb-2 ps-5 pe-5 ">
                    ...
                    >
                      <img
                        role="presentation"
                        alt=""
                        srcset="https://secure.meetupstatic.com/next/images/login/email.svg?w=32 1x, https://secure.meetupstatic.com/next/images/login/email.svg?w=48 2x"
                        src="https://secure.meetupstatic.com/next/images/login/email.svg?w=48"
                        style={{ color: "transparent" }}
                      ></img>
                      Sign up with Email
                    </a>
